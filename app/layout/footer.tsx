...
export default function Footer() {
  return (
    <div data-testid="footer" className="w-full z-10 h-20 text-xs flex sm:flex-row flex-col sm:justify-between p-2 items-center justify-center border-t border-slate-800 ">
